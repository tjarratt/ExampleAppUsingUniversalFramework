...
- (void)viewDidLoad
{
    ...
    ExampleFramework *frameworkObject = [[ExampleFramework alloc] init];

    NSArray *things = [frameworkObject allTheThings];
    for (id someObject in [things reverseObjectEnumerator]) {
        [self insertNewObject:someObject];
    };
}
